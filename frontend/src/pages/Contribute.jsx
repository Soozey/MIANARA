...
export default function Contribute() {
  ...
  const [formData, setFormData] = useState({
    ...
    file_type: "", // Changed default to empty to force selection
    body: "",
    file_url: null,
    is_monetized: false,
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    { id: "LANGUE", label: "Langues", icon: "🗣️" },
                    { id: "SCOLAIRE", label: "Scolaire", icon: "🎓" },
                    { id: "PRO", label: "Formation Pro", icon: "🛠️" },
                    { id: "SANTE", label: "Santé", icon: "🏥" },
                    { id: "CITOYEN", label: "Citoyenneté", icon: "🏛️" },
                    { id: "ENTREPRENEURIAT", label: "Business", icon: "💼" },
                    ...
                    <button
                      ...
                      className={`p-4 rounded-xl border-2 flex flex-col items-center justify-center gap-2 transition-all duration-200 ${formData.category === cat.id
                          ? "border-primary-600 bg-primary-50 text-primary-700 shadow-md transform scale-105"
                          : "border-gray-100 bg-white text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:-translate-y-1"
                        }`}
                    >
